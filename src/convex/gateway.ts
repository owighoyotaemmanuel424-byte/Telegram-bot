...
export interface ConvexJobGateway {
  create(input: { userId: string; intent: string; prompt: string; creditsReserved: number; reference: string; telegramChatId?: string; telegramStatusMessageId?: number; conversationId?: string; sourceAssetIds?: string[] }): Promise<{ jobId: string }>;
