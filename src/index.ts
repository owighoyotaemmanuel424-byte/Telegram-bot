...
const appBuilder = aiProvider && config.GITHUB_TOKEN && config.GITHUB_OWNER && config.GITHUB_REPOSITORY ? new AppBuilderService(aiProvider, vercelDeployer) : undefined;
