...
const appBuilder = geminiClient && config.GITHUB_TOKEN && config.GITHUB_OWNER && config.GITHUB_REPOSITORY ? new AppBuilderService(geminiClient, vercelDeployer) : undefined;
